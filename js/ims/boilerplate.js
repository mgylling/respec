define(["exports"], function (exports) {
  ...
  //adds the IMS default boilerplate elements
  ...
  function run(conf, doc, cb) {
    ...
    var versionTable = toElement(`<table id='versionTable' title='Version/Release Details' summary='Details about the version and release.'>
    <tbody><tr>
    ...
    <td><a href='${conf.canonicalURI}'>${conf.canonicalURI}</a></td></tr></tbody></table>`);
    ...
    var copyRight = toElement(`<div id="cpr">      
        ...
        <p>Refer to the <a href="#ipr">IPR and Distribution Notices</a> for this document.</p>
      </div>`);
